...
public class TC003_POST_CreateEmployee extends TestBase {
	...
	public String tagName = "Endpoint: POST_CreateEmployee";
	public String testCase = "POST Create New Employee";

	// Test Data
	public String employeeName = "QA Automation";
	public String employeeSalary = "900000";
	public String employeeAge = "32";
	...
	void postCreateEmployee() {
		...
		createdId = response.jsonPath().get("data.id").toString();
	}
	...
	void verifyStatusMessage() {
		...
		if (jsonPath.get("message").toString().equalsIgnoreCase("Successfully! Record has been added.")
